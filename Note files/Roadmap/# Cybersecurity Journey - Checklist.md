...
- [x] Understand TCP/IP Model (4 layers) — _covered incl. 3-way handshake & SYN flood_
- [x] Master IPv4 addressing
- [x] Practice subnetting (10 exercises)
- [ ] Understand CIDR notation
- [x] Learn IPv6 basics — _covered (IPv4 vs IPv6 comparison)_
- [x] Understand MAC addresses — _covered (OUI, spoofing, ARP poisoning)_
- [ ] Know how DNS works — _covered (resolution flow, spoofing, tunneling, DNSSEC)_
- [ ] Know how DHCP works
- [x] Understand routing basics
